...
namespace LuminousCandle.Controllers
{
    public class CandlesController : Controller
    {
        private readonly LuminousCandleContext _context;

        public CandlesController(LuminousCandleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DeliveryDate,Wax,Fragrance")] Candle candle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DeliveryDate,Wax,Fragrance")] Candle candle)
        {
            if (id != candle.Id)
            {
                return NotFound();
